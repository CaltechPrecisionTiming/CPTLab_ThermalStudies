...
int main (void)
{
  ...
  for (int n=0; n<NumADC; n++) rp1->initialize(n);
  ...
  while(1){
    ...
    for (int n=0; n<NumADC; n++){
      rp1->activate(n+1);
      std::cout<<"ADC "<<n+1<<" activated"<<std::endl;
    ...
    std::cout<<std::endl;
    std::cout<<"Temperature_in_1 = "<<TT<<"|| Humidity_in_1 = "<<HH<<" ||"<<std::endl;
    //std::cout<<"Temperature_ex = "<<TT2<<"|| Humidity_ex = "<<HH2;
    std::cout<<"Temperature_HIH6130 = "<<TT_HIH6130<<"|| Humidity_HIH6130 = "<<HH_HIH6130<<" ||"<<std::endl;
    std::cout<<"Temperature_Si7021 = "<<TT_Si7021<<"|| Humidity_Si7021 = "<<HH_Si7021<<" ||"<<std::endl;
    std::cout<<"-------------------------------------------------------------------------------------------------------------------------"<<std::endl;
